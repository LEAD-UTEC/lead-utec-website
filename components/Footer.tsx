...
const footerLinks = {
  ...
  getInvolved: [
    ...
    { label: 'Attend Events', href: '#impact' },
    { label: 'Partner with Us', href: 'mailto:leadutec@utec.edu.pe' },
    { label: 'Contact Us', href: 'mailto:leadutec@utec.edu.pe' },
  ],
  resources: [
...
export function Footer() {
  return (
    <footer className="border-t border-white/10 bg-[#010b3d]">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-white/60 text-sm leading-relaxed mb-6 max-w-sm">
              Building Latin America&apos;s tech leaders. Official student organization at Universidad de Ingenieria y Tecnologia (UTEC, Peru). Student chapter of LEAD Global.
            </p>
            <div className="flex gap-4">
              <a
                href="https://chat.whatsapp.com/EYwMAAPAymZ8H20AqneKZg"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/company/leadatutec/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-white/60 hover:text-white hover:bg-white/10 transition-all"
                aria-label="LinkedIn"
              ...
              <a
                href="mailto:leadutec@utec.edu.pe"
                className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-white/60 hover:text-white hover:bg-white/10 transition-all"
                aria-label="Email"
              >
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-white/40">
            &copy; 2026 LEAD UTEC. All rights reserved.
          </p>
